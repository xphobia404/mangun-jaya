...
<body>
        ...
        <div class="container">
            <div class="navbar__inner">
                ...
                <div class="navbar__actions">
                    ...
                    <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" class="btn btn--primary" style="font-size:var(--text-sm);padding:0.6rem 1.2rem;">
    ...
    <div class="mobile-nav" id="mobileNav" role="dialog" aria-label="Menu mobile">
        ...
        <div class="mobile-nav__cta">
            <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" class="btn btn--primary" style="width:100%;justify-content:center;">
    ...
    <!-- WhatsApp Float -->
    <a href="https://wa.me/6281234567890?text=Halo%20Mangun%20Jaya%2C%20saya%20ingin%20tanya%20mengenai%20plafon" target="_blank" rel="noopener noreferrer" class="wa-float" aria-label="Chat WhatsApp">
            ...
            <div class="footer__grid">
                ...
                <div>
                    ...
                    <div class="footer__links" style="gap:var(--space-3);">
                        <a href="tel:+6281234567890" class="footer__link" style="display:flex;align-items:flex-start;gap:var(--space-2);">
                            <i data-lucide="phone" style="width:15px;height:15px;flex-shrink:0;margin-top:2px;"></i>
                            <span>+62 812-3456-7890</span>
                        </a>
                        <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" class="footer__link" style="display:flex;align-items:flex-start;gap:var(--space-2);">
